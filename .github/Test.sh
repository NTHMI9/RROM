...
sudo mkdir $TOME/tmp/vendor
sudo touch $TOME/tmp/vendor/build.prop
sudo echo 'import /vendor/${ro.boot.product.hardware.sku}.build.prop' >> $TOME/tmp/vendor/build.prop
cat $TOME/tmp/vendor/build.prop
