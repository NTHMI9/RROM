...
sudo mkdir $TOME/vendor
sudo touch $TOME/vendor/build.prop
sudo echo 'import /vendor/${ro.boot.product.hardware.sku}.build.prop' >> $TOME/vendor/build.prop
cat $TOME/vendor/build.prop
